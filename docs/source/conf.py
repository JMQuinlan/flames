...
# ignore the "duplicate label" warnings generated by automatic section labelling
...
latex_documents = [
    (master_doc, 'alamo.tex', u'alamo Documentation',
     u'Brandon Runnels', 'manual'),
]
...
man_pages = [
    (master_doc, 'alamo', u'alamo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'alamo', u'alamo Documentation',
     author, 'alamo', 'One line description of project.',
     'Miscellaneous'),
]
