"""
===============================================================================
TEST 3 -- SHOCK / DROPLET INTERACTION (NO VAPORIZATION) ANALYSIS SCRIPT
===============================================================================

PURPOSE:
    Full diagnostic of the Test3_ShockDroplet_SinVap (vaporization OFF) case
    ...
    deformation metrics, etc.) are retained from the parent script.
...
PLOT_SCHLIEREN_VAPDOTRHO_SPLIT = 0      # OFF for Test 3 (no vaporization data)
PLOT_SCHLIEREN_VAPDOTRHO_GIF   = 0      # OFF for Test 3 (no vaporization data)
...
# ---------------------------------------------------------------------------
# File paths -- match the Test3_ShockDroplet_SinVap input file
# ---------------------------------------------------------------------------
#amrex_output_dir = r'../../../bin/tests/FlowPatel/Test3_ShockDroplet_SinVap'
amrex_output_dir = r'/mmfs1/home/ttryon/flames/bin/tests/FlowPatel/Test3_ShockDroplet_SinVap'
#amrex_output_dir = r'/mmfs1/home/spatel6/flames/bin/tests/FlowPatel/Test3_ShockDroplet_SinVap'

output_folder = './Test3_NonVap_Analysis'

# ---------------------------------------------------------------------------
# Physical parameters -- match Test3_ShockDroplet_SinVap input
# ---------------------------------------------------------------------------
