#!/bin/bash
# 3D Marmottant static-Laplace bubble (octant), R0 = 0.850 mm, buckled branch.
# Input : tests/FlowMarmottant/3D_Bubble/input_R000850000   (stop_time = 20 ms)
# Output: /mmfs1/home/ttryon/flames/bin/tests/FlowMarmottant/3D_Bubble/output_R000850000
#
...
#   restart=/mmfs1/home/ttryon/flames/bin/tests/FlowMarmottant/3D_Bubble/output_R000850000/NNNNNcell
# appended to the srun line (loses <= one plot_dt = 1 ms).
#
#SBATCH --job-name=M3D_850000
...
INP=/home/ttryon/flames/tests/FlowMarmottant/3D_Bubble/input_R000850000
