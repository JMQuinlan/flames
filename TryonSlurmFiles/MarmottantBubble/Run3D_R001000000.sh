#!/bin/bash
# 3D Marmottant static-Laplace bubble (octant), R0 = 1.000 mm, buckled branch.
# Input : tests/FlowMarmottant/3D_Bubble/input_R001000000   (stop_time = 20 ms)
# Output: /mmfs1/home/ttryon/flames/bin/tests/FlowMarmottant/3D_Bubble/output_R001000000
#
...
#   restart=/mmfs1/home/ttryon/flames/bin/tests/FlowMarmottant/3D_Bubble/output_R001000000/NNNNNcell
# appended to the srun line (loses <= one plot_dt = 1 ms).
#
#SBATCH --job-name=M3D_1000000
...
INP=/home/ttryon/flames/tests/FlowMarmottant/3D_Bubble/input_R001000000
