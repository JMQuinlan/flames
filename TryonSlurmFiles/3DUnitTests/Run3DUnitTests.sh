...
#
# =============================================================================
# 3D UNIT TEST SUITE  --  single sequential SLURM job (INCLINE)
# =============================================================================
...
#
# Submit:   sbatch TryonSlurmFiles/3DUnitTests/Run3DUnitTests.sh
# =============================================================================

#SBATCH --job-name=3DUnitTests
#SBATCH -o /mmfs1/home/ttryon/FLAMES_out/unit3d_%j_stdout
#SBATCH -e /mmfs1/home/ttryon/FLAMES_out/unit3d_%j_stderr
#SBATCH -N 1
...
RUN $TESTS/FlowLaplace/UNIT_TEST_3D_R1.0e-3_Sigma7.3e-2
RUN $TESTS/FlowLaplace/UNIT_TEST_3D_R1.0e-4_Sigma3.6e-2
RUN $TESTS/FlowLaplace/UNIT_TEST_3D_R1.0e-4_Sigma7.3e-2
RUN $TESTS/FlowLaplace/UNIT_TEST_3D_R1.0e-5_Sigma3.6e-2
RUN $TESTS/FlowLaplace/UNIT_TEST_3D_R1.0e-5_Sigma7.3e-2

echo
echo "=== 3D UNIT TEST SUITE COMPLETE   (total: $((SECONDS - suite_start)) s) ==="
echo "    analyze: python TryonSlurmFiles/3DUnitTests/aggregate_unit_tests.py"
